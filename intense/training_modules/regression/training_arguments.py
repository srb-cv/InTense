...
class TrainingArguments:
    ...
    tf_latent_dim: int | None = None
    tf_indices: list | None = None
...
def get_argument_parser(parser):
    ...
    parser.add_argument(
        "--track-complexity", help="Track complexity of the model",
        action="store_true"
    )
    parser.add_argument(
        "--reg-param",
    ...
    parser.add_argument(
        "--robust-test", help="Robust test for the dataset", action="store_true"
    )
    parser.add_argument(
        "--z-norm", help="Z normalization for the dataset", action="store_true"
    )
    parser.add_argument(
        "--is-packed", help="Packed sequences for the dataset", action="store_true"
    )
    parser.add_argument(
        "--label-norm",
